    ...
    <div className="mx-auto max-w-6xl space-y-8 pb-12">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Manage your balance and deposit funds using your preferred method.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
        ...
        <div className="md:hidden rounded-2xl bg-gradient-to-br from-primary to-secondary p-5 flex flex-col shadow-md shadow-primary/25 relative overflow-hidden">
          ...
          <div className="flex items-center gap-3 mb-6 relative z-10">
            ...
            <div className="flex flex-col">
              <span className="text-xs font-semibold text-white/90 -mb-1">
                Available Balance
              </span>
        ...
        <div className="hidden md:flex md:col-span-1 rounded-[2rem] bg-gradient-to-br from-primary to-secondary text-white p-8 flex-col justify-between shadow-lg shadow-primary/25 min-h-[300px] relative overflow-hidden">
          {/* Decorative background shapes */}
        ...
        <div className="md:col-span-2 rounded-[2rem] border border-border bg-card shadow-sm overflow-hidden flex flex-col">
          ...
          >
            <div className="space-y-6">
              ...
              <div>
                <label
                  htmlFor="amount"
                  className="block text-xs font-bold uppercase tracking-widest text-foreground mb-2"
                >
                  Amount (USD)
                </label>
                <div className="relative">
                  ...
                  <input
                    type="number"
                    id="amount"
                    className="w-full bg-muted/60 border-2 border-transparent rounded-[1.25rem] py-4 pl-8 text-sm font-bold text-foreground focus:bg-card focus:border-primary/20 focus:ring-4 focus:ring-primary/10 outline-none transition-all placeholder:text-muted-foreground/60"
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center rounded-[1rem] border-2 py-4 text-sm font-bold transition-all ${
                      method === "card"
                        ...
                        : "border-border bg-muted/40 text-muted-foreground hover:bg-muted/60 hover:border-border"
                    }`}
                  >
            ...
            <div className="pt-8 mt-6">
              ...
              <div className="flex gap-4 justify-end">
                <button
                  type="button"
                  className="rounded-xl bg-muted border border-border px-8 py-3.5 text-sm font-bold text-foreground shadow-sm hover:bg-muted/80 transition-colors"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="rounded-xl bg-primary px-8 py-3.5 text-sm font-bold text-white shadow-lg shadow-primary/25 hover:bg-primary/90 transition-all hover:-translate-y-0.5"
                >
                  Add Balance
                </button>
              </div>
      ...
      <div className="rounded-[2rem] border border-border bg-card shadow-sm overflow-hidden flex flex-col h-full mt-10">
          ...
          <table className="min-w-full divide-y divide-border">
            <thead className="bg-muted/50">
              <tr>
                <th
                  scope="col"
                  className="px-8 py-4 text-left text-xs font-bold uppercase tracking-widest text-muted-foreground"
                >
                  ID
                </th>
                <th
                ...
                <th
                  scope="col"
                  className="px-8 py-4 text-right text-xs font-bold uppercase tracking-widest text-muted-foreground"
                >
                  Date
                </th>
              </tr>
            ...
            <tbody className="divide-y divide-border bg-card">
              {transactions.map((txn) => (
                ...
                >
                  <td className="whitespace-nowrap px-8 py-5 text-sm font-bold text-foreground">
                    {txn.id}
                  </td>
                  ...
                  <td className="whitespace-nowrap px-8 py-5 text-right text-sm font-semibold text-muted-foreground">
                    {txn.date}
                  </td>
                </tr>
              ))}
