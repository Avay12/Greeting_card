    ...
    <div className="max-w-3xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-foreground font-heading">
          Create Greeting Link
        </h1>
        <p className="mt-2 text-muted-foreground">
          Generate a personalized link to send to someone special.
        </p>
      </div>
        ...
        {successLink ? (
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground mb-8">
              You can now share this unique greeting link.
            </p>

            <div className="bg-muted p-4 rounded-xl border border-border flex items-center gap-4 mb-8">
              ...
              <button
                ...
                className="px-4 py-2 bg-card border border-border rounded-lg text-sm font-semibold hover:bg-muted transition-colors"
              >
                Copy
              </button>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Edit3 className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground/60" />
                  <input
                    type="text"
                    name="recipientName"
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                rows={5}
                required
                className="w-full bg-muted border border-border rounded-xl p-4 focus:bg-card focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all resize-none"
              />
            </div>
