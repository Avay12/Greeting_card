    ...
    <div className="max-w-5xl mx-auto">
      <div className="mb-8 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-muted-foreground bg-muted border border-border px-3 py-1 rounded-full text-sm inline-block">
        ...
        {sections.map((section, index) => {
          ...
          return (
            <motion.div
              ...
              className="bg-card rounded-2xl shadow-sm border border-border p-6 hover:shadow-md transition-shadow cursor-pointer group"
            >
              <div
                className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 transition-transform group-hover:scale-110 ${section.bg}`}
              >
